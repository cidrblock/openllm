...
function createBaseSessionChatRequest(): SessionChatRequest {
  return { sessionId: "", message: undefined, options: undefined };
}
...
export const McpBridgeDefinition = {
  ...
  methods: {
    ...
    listMcpTools: {
      name: "ListMcpTools",
      requestType: ListMcpToolsRequest,
      requestStream: false,
      responseType: ListMcpToolsResponse,
    ...
    callTool: {
      ...
      requestStream: false,
      responseType: ToolResponseChunk,
      responseStream: true,
      options: {},
    },
    ...
    callToolInteractive: {
      ...
      requestType: ToolInteractiveRequest,
      requestStream: true,
      responseType: ToolResponseChunk,
      responseStream: true,
      options: {},
    ...
    callToolsBatch: {
      name: "CallToolsBatch",
      requestType: CallToolsBatchRequest,
      requestStream: false,
      responseType: ToolResponseChunk,
      responseStream: true,
      options: {},
    ...
    getPrompt: {
      name: "GetPrompt",
      requestType: GetPromptRequest,
      requestStream: false,
      responseType: GetPromptResponse,
      responseStream: false,
      options: {},
    },
  },
...
/** Chat */
export type OpenLLMDefinition = typeof OpenLLMDefinition;
export const OpenLLMDefinition = {
  name: "OpenLLM",
  fullName: "openllm.v1.OpenLLM",
  methods: {
    ...
    sessionChat: {
      name: "SessionChat",
      requestType: SessionChatRequest,
      requestStream: false,
      responseType: ChatChunk,
      responseStream: true,
      options: {},
    ...
    watchSessions: {
      name: "WatchSessions",
      requestType: WatchSessionsRequest,
      requestStream: false,
      responseType: SessionEvent,
      responseStream: true,
      options: {},
    },
    ...
    replaySession: {
      name: "ReplaySession",
      requestType: ReplaySessionRequest,
      requestStream: false,
      responseType: ReplaySessionResponse,
      responseStream: false,
      options: {},
    },
    ...
    summarizeSession: {
      ...
      requestType: SummarizeSessionRequest,
      requestStream: false,
      responseType: SummarizeSessionResponse,
      responseStream: false,
      options: {},
    },
    ...
    forkSession: {
      name: "ForkSession",
      requestType: ForkSessionRequest,
      requestStream: false,
      responseType: Session,
      responseStream: false,
      options: {},
    ...
    getProviderStatus: {
      ...
      requestType: GetProviderStatusRequest,
      requestStream: false,
      responseType: ProviderStatus,
      responseStream: false,
      options: {},
    },
    ...
    executeTool: {
      name: "ExecuteTool",
      requestType: ExecuteToolRequest,
      requestStream: false,
      responseType: ExecuteToolResponse,
      responseStream: false,
      options: {},
    },
    ...
    getConnectedWorkspaces: {
      ...
      requestType: GetConnectedWorkspacesRequest,
      requestStream: false,
      responseType: GetConnectedWorkspacesResponse,
      responseStream: false,
      options: {},
    },
    ...
    registerMcpServer: {
      ...
      requestType: RegisterMcpServerRequest,
      requestStream: false,
      responseType: Empty,
      responseStream: false,
      options: {},
    ...
    unregisterMcpServer: {
      ...
      requestType: UnregisterMcpServerRequest,
      requestStream: false,
      responseType: Empty,
      responseStream: false,
      options: {},
    ...
    vSCodeStream: {
      name: "VSCodeStream",
      requestType: VSCodeResponse,
      requestStream: true,
      responseType: VSCodeRequest,
      responseStream: true,
      options: {},
    },
  },
...
export interface OpenLLMServiceImplementation<CallContextExt = {}> {
  /** Stateless chat (no session persistence) */
  chat(
    request: ChatRequest,
    context: CallContext & CallContextExt,
...
export interface OpenLLMClient<CallOptionsExt = {}> {
  /** Stateless chat (no session persistence) */
