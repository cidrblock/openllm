...
import { getDefaultSocketPath, ensureSocketDir, cleanupSocket, writePidFile, removePidFile, readPidFile, isDaemonRunningSync, killDaemon, isProcessRunning, } from './transport.js';
...
export async function startDaemon(opts) {
    ...
    await new Promise((resolve, reject) => {
        server.bindAsync(`unix://${socketPath}`, grpc.ServerCredentials.createInsecure(), (error, port) => {
            if (error) {
                reject(error);
            }
            else {
