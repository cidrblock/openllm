...
pub use traits::{Provider, ProviderModelConfig, StreamChatOptions, StreamResponse, DynamicModelInfo};
...
pub fn create_vscode_provider(client: Arc<crate::mcp::McpClient>, logger: Arc<dyn Logger>) -> Box<dyn Provider> {
